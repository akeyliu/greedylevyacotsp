...
fprintf_parameters (FILE *stream)
{
    ...
    fprintf(stream,"levy_flag               %ld\n", iLevyFlag);
    fprintf(stream,"levy_threadhold         %lf\n", dLevyThreshold);
    fprintf(stream,"levy_ratio              %lf\n", dLevyRatio);
    fprintf(stream,"contribution_ratio      %ld\n", dContribution);
    fprintf(stream,"greedy_levy_flag        %ld\n", iGreedyLevyFlag);
    fprintf(stream,"greedy_epsilon          %lf\n", dGreedyEpsilon);
    fprintf(stream,"greedy_levy_threadhold  %lf\n", dGreedyLevyThreshold);
    fprintf(stream,"greedy_levy_ratio       %lf\n", dGreedyLevyRatio);
}
...
*/
{
  ...
  fprintf(stderr, "%ld,%lf,%lf,%lf,%ld,%lf,%lf,%lf, %ld,%ld,%lf\n", iLevyFlag,dLevyThreshold, dLevyRatio, dContribution, iGreedyLevyFlag, dGreedyEpsilon, dGreedyLevyThreshold, dGreedyLevyRatio, best_tour_length, found_best, elapsed_time( VIRTUAL ));
